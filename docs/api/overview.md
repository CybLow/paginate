...
This section provides comprehensive API documentation for all pypaginate modules. Documentation is automatically generated from source code docstrings using [sphinx-autoapi](https://sphinx-autoapi.readthedocs.io/).

## Module Overview

| Module | Description |
|--------|-------------|
| [Core](pypaginate/core/index.rst) | Core types: `Page`, `PageParams`, pagination context |
| [Engines](pypaginate/engines/index.rst) | Pagination engines: `SqlPaginator`, `MemoryPaginator` |
| [Filters](pypaginate/filters/index.rst) | Filtering: predicates, JSON Logic, field accessors |
| [Search](pypaginate/filters/search/index.rst) | Text search: fuzzy matching, SQL search |
| [Sorting](pypaginate/sorting/index.rst) | Sorting: `SortEngine`, `SqlSortAdapter` |
| [Integrations](pypaginate/integrations/index.rst) | Framework integrations: FastAPI |
| [Exceptions](pypaginate/exceptions/index.rst) | Exception classes for error handling |

```{seealso}
For the complete auto-generated API reference with all classes, functions, and type annotations, see the [Full API Reference](pypaginate/index.rst).
```
