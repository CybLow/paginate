...
class SQLAlchemyCursorBackend(Generic[ItemT]):
    ...
    async def fetch_page(
        ...
        *,
        ...
        """
        page = await _select_keyset_page(
            self._session,
            query,
            limit,
            after,
...
async def _select_keyset_page(
    ...
    """
    # sqlakeyset requires a real async DB with ORDER BY; not testable
    # in unit tests with async SQLite.
...
__all__ = ["SQLAlchemyCursorBackend"]
