...
**Counting rule**: Comments, blank lines, and docstrings do NOT count toward line limits. Only executable and declarative code lines count.
...
| Metric | Limit |
|--------|-------|
| Lines per file (code) | 250 |
| Lines per function (body) | 15 |
