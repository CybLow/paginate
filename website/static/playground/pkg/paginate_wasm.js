/* @ts-self-types="./paginate_wasm.d.ts" */
...
export function decodeCursor(cursor) {
    ...
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(cursor, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.decodeCursor(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {string}
 */
export function filter(items_json, field, operator, value_json) {
    let deferred6_0;
    let deferred6_1;
    try {
        ...
        const ptr2 = passStringToWasm0(operator, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passStringToWasm0(value_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        const ret = wasm.filter(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
        var ptr5 = ret[0];
        var len5 = ret[1];
        if (ret[3]) {
            ptr5 = 0; len5 = 0;
 ...
 * @returns {string}
 */
export function search(items_json, query, fields_json, fuzzy) {
    let deferred6_0;
    let deferred6_1;
    try {
        const ptr0 = passStringToWasm0(items_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        ...
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passStringToWasm0(fuzzy, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        const ret = wasm.search(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
        var ptr5 = ret[0];
        var len5 = ret[1];
        if (ret[3]) {
            ptr5 = 0; len5 = 0;
 ...
 * @returns {string}
 */
export function sort(items_json, field, direction) {
    let deferred5_0;
    let deferred5_1;
    try {
        const ptr0 = passStringToWasm0(items_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        ...
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.sort(ptr0, len0, ptr1, len1, ptr2, len2);
        var ptr4 = ret[0];
        var len4 = ret[1];
        if (ret[3]) {
            ptr4 = 0; len4 = 0;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('paginate_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
